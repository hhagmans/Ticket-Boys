...
public class ConflictDaoSqlite extends BaseDaoSqlite<Conflict> implements ConflictDao, Serializable
{
	...
	{
		Query setParameter = getEm().createNamedQuery("Conflict_findAll", Conflict.class);

		ArrayList<Conflict> conflictList = new ArrayList<Conflict>(setParameter.getResultList());
